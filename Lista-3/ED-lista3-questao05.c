/*
    * Função: Mostrar todos os valores da Conjectura de Goldbach entre 2 e o número n inserido pelo usuário.
...
int main() {
    ...
    printf("| Digite um valor n para mostrar os valores da Conjectura de Goldbach de 2 ate o valor n informado: ");
